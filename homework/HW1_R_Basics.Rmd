...
When I first ran the Tidyverse code, it said error. I looked it up and it said that I had to write "install.packages("tidyverse")" into my console so I did and it downloaded a lot, but still said there were a few conflicts. Was this what I was meant to do?
